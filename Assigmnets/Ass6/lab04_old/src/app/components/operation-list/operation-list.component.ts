...
export class OperationListComponent implements OnInit {
  ...
  constructor(public atmService: AtmServiceService) { }  
    ...
    */
      ...
      this.showBalance(this.atmService.getAccountNumber());

      setTimeout(() => {
        this.makeADeposit(this.atmService.getAccountNumber(), 100);
      }, 2000);

      setTimeout(() => {
        this.makeAWithdraw(this.atmService.getAccountNumber(), 50);
      }, 4000);
